...
class AprioriCalculation
{
    ...
    String configFile="File/Apriori/config.txt"; //configuration file
    String transaFile="File/Apriori/Adult.csv"; //transaction file
    String outputFile="File/Apriori/apriori-output.txt";//output file
